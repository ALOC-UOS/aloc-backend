...
//				.file("file", "dummy content".getBytes())  // Create a dummy file
//				.contentType(MediaType.MULTIPART_FORM_DATA))
//			.andExpect(status().isOk())
//			.andExpect(content().string("File uploaded successfully: uploadedFileName.jpg"));
//	}
//
//	@Test
...
//		// Mocking the image upload service
//		Mockito.when(imageUploadService.uploadImage(any(MultipartFile.class), eq(ImageType.PROFILE), anyMap()))
//			.thenReturn(uploadedFileInfo);
//

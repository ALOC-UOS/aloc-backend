...
class HistoryControllerTest {
  ...
  void setUp() {
    ...
    HistoryContentDto content1 =
        HistoryContentDto.builder().icon("plusMember").name("홍길동").rank(null).build();
    HistoryContentDto content2 =
        HistoryContentDto.builder().icon("plusMember").name("김장군").rank(null).build();
    HistoryContentDto content3 =
        HistoryContentDto.builder().icon("changeRank").name("홍길동").rank(33).build();
    HistoryContentDto content4 =
        HistoryContentDto.builder().icon("changeRank").name("홍길동").rank(32).build();
    HistoryContentDto content5 =
        HistoryContentDto.builder().icon("plusMember").name("박돌쇠").rank(null).build();
    HistoryContentDto content6 =
        HistoryContentDto.builder().icon("changeRank").name("홍길동").rank(31).build();
  ...
  void testGetHistories() throws Exception {
    ...
    mockMvc
        .perform(get("/api2/history").contentType(MediaType.APPLICATION_JSON))

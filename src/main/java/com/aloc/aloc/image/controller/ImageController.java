...
public class ImageController {
  ...
  public ResponseEntity<UploadedImageResponseDto> uploadItemImage(
    ...
    UploadedImageResponseDto responseDto =
        new UploadedImageResponseDto(
            "Item File uploaded successfully", uploadedImage.getImageName());
  ...
  public ResponseEntity<UploadedImageResponseDto> uploadProfileImage(
    ...
    UploadedImageInfo uploadedImage =
        imageUploadService.uploadImage(file, ImageType.PROFILE, metadata);
    UploadedImageResponseDto responseDto =
        new UploadedImageResponseDto(
            "Profile File uploaded successfully", uploadedImage.getImageName());
    return ResponseEntity.ok(responseDto);
  }
}

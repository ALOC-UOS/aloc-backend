...
public class ProblemService {
	...
	List<Problem> getVisibleProblemsByAlgorithm(int season, int algorithmId, Course course) {
		...
		return problemRepository.findPublicProblemsByAlgorithmAndCourse(season, algorithmId, problemType.getId());
	}

	public List<ProblemResponseDto> getVisibleProblemsDtoByAlgorithm(int season, int algorithmId, Course course) {
		List<Problem> problems = getVisibleProblemsByAlgorithm(season, algorithmId, course);
